...
"""This file defines functions needed to create logs in 2.x RTO.

These functions create logs used for debugging, particularly useful in Airflow and adhoc runs.
"""
import json
import logging
import os
